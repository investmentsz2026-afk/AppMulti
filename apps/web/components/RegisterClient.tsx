...
export default function RegisterClient() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-background relative">
      ...
      <div className="hidden lg:flex relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <h1 className="text-6xl font-black text-white leading-tight mb-6">
            Únete a la <br />
            comunidad de <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">LiveX</span> hoy.
          </h1>
      ...
      {/* Right Side - Form */}
      <div className="flex flex-col items-center justify-center p-6 md:p-12 relative z-10 min-h-screen lg:min-h-0 pt-16 lg:pt-6 overflow-y-auto">
        ...
        <div className="lg:hidden flex flex-col items-center gap-3 mb-8 mt-4">
            ...
            <div className="text-center mt-2">
               ...
               <p className="text-zinc-400 font-medium text-sm">Únete a la comunidad de LiveX</p>
            </div>
        </div>
          ...
          <div className="glass-morphism p-8 lg:p-10 rounded-[40px] border border-white/5 shadow-2xl bg-[#0e1129]/80 lg:bg-[#0e1129]/60 backdrop-blur-xl">
            ...
            <form onSubmit={handleRegister} className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full bg-[#050816]/50 border border-white/5 rounded-2xl py-3.5 pl-12 pr-4 text-sm outline-none focus:border-purple-500/50 transition-all placeholder:text-zinc-700"
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full bg-[#050816]/50 border border-white/5 rounded-2xl py-3.5 pl-12 pr-12 text-sm outline-none focus:border-purple-500/50 transition-all placeholder:text-zinc-700"
                    placeholder="••••••••"
                    required
                  />
                  <button 
              ...
              <button 
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-black py-4 rounded-2xl shadow-xl shadow-pink-500/20 hover:scale-[1.02] transition-all flex items-center justify-center gap-2"
              >
                {loading ? 'Registrando...' : 'Registrarme'} <ArrowRight className="w-5 h-5" />
              </button>
            </form>
            ...
            <div className="grid grid-cols-3 gap-4 mt-8">
                 <button 
                   ...
                   className="flex items-center justify-center py-3.5 rounded-2xl bg-white/5 border border-white/5 transition-all hover:bg-white/10 group cursor-pointer"
            ...
            <div className="mt-8 text-center text-sm font-medium text-zinc-500">
              ¿Ya tienes cuenta? <Link href="/login" className="text-purple-500 font-black hover:underline ml-1">Inicia sesión</Link>
            </div>
          </div>
        </motion.div>
      </div>
