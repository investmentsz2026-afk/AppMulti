            ...
            <div key={post.id} className="h-full w-full snap-start snap-always relative flex flex-col justify-between overflow-hidden bg-black">
              ...
              >
                ...
                <form 
                  ...
                  className="p-2.5 pb-[calc(10px+env(safe-area-inset-bottom,0px))] border-t border-white/5 bg-[#07070b] shrink-0"
                >
              ...
              <div className="max-h-[160px] overflow-y-auto custom-scrollbar flex flex-col gap-2">
                {friendsForShare.length > 0 ? (
                  friendsForShare.map((chat: any) => {
                    ...
                    return (
                      <div key={chat.user.id} className="flex items-center justify-between gap-3 bg-white/5 hover:bg-white/10 p-2 rounded-xl border border-white/5 transition-all">
